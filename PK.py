...
CHANNEL_ID = '-1002636881929'  # Replace with your specific channel or group ID
# Initialize the bot
...
def welcome_start(message):
    ...
    bot.send_message(
            message.chat.id,
            f"👋🏻Welcome {user_name}.\n\n"
            f"[➖ 𝗖𝗟𝗜𝗖𝗞 𝗛𝗘𝗥𝗘 𝗧𝗢 𝗝𝗢𝗜𝗡 ➖](https://t.me/Ritikxyz9)\n\n"    
    ...
    bot.send_message(
            message.chat.id,
            f" [➖𝗗𝗠 𝗙𝗢𝗥 𝗥𝗘𝗕𝗥𝗔𝗡𝗗𝗜𝗡𝗚➖](https://t.me/RitikXyz099)\n\n                                                      ↖️",
    parse_mode="Markdown",
    disable_web_page_preview=True  # This disables the link preview
    )
...
def reset_attack_limit(message):
    owner_id = 6437994839  # Replace with the actual owner ID
    ...
    response = (
        ...
        "━━━━━━━━━━━━━━━━━━━\n"
        "🔗 *𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬: [RITIK](https://t.me/RitikXyz099) ⚡*"
    )
...
FEEDBACK_CHANNEL_ID = "-1002447886308"  # Replace with your actual feedback channel ID
